...
constructor(
    ...
    fun getTeamBookingsStream(
            ...
            year: Int,
            month: Int,
    ): Flow<Result<List<Booking>>> = callbackFlow {
    ...
    fun getTeamPendingRequestsStream(teamId: String): Flow<Result<List<Booking>>> = callbackFlow {
        val listenerRegistration =
                firestore
                        .collection(Booking.COLLECTION_NAME)
                        .whereEqualTo(Booking.TEAM_ID_FIELD, teamId)
    ...
    fun getUserBookingsStream(userId: String): Flow<Result<List<Booking>>> = callbackFlow {
        val listenerRegistration =
                firestore
                        .collection(Booking.COLLECTION_NAME)
                        .whereEqualTo(Booking.USER_ID_FIELD, userId)
